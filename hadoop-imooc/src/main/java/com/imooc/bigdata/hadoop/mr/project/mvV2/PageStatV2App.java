...
//        Path outputPath = new Path("projectData/output/v2/pagestat");
        ...
        // FileOutputFormat.setOutputPath(job, new Path("projectData/output/v2/pagetat/"));FileInputFormat.setInputPaths(job, new Path("projectData/input/etl"));
